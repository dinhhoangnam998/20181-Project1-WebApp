					...
					<li class="nav-item dropdown open"><a
						...
						<div class="dropdown-menu">
							<a class="text-white dropdown-item display-7"
								...
								class="text-white dropdown-item display-7"
								href="/Project1WebApplication/admin/type/" aria-expanded="true">Type</a><a
								class="text-white dropdown-item display-7"
								href="/Project1WebApplication/admin/publisher/"
								aria-expanded="true">Publisher<br></a><a
								class="text-white dropdown-item display-7"
			...
			<div class="row justify-content-center">
				<div class="media-container-column col-lg-8"
					...
					<form:form method="POST"
						action="/Project1WebApplication/admin/book/edit"
						modelAttribute="book">
						...
						<div class="row row-sm-offset">
							<div class="col-md-4 multi-horizontal" data-for="name">
								<div class="form-group">
									<form:label
										...
										path="language">language</form:label>
							...
							<div class="col-md-4 multi-horizontal" data-for="email">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="pagenumber">pagenumber</form:label>
									<form:input path="pagenumber" type="number"
										class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="phone">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="republishno">republishno</form:label>
									<form:input path="republishno" type="number"
										class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="phone">
							...
							<div class="col-md-4 multi-horizontal" data-for="phone">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="coverprice">coverprice</form:label>
									<form:input path="coverprice" type="number"
										class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="phone">
							...
							<div class="col-md-4 multi-horizontal" data-for="phone">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="creation.id">creation</form:label>
									<form:select path="creation.id" class="form-control">
							...
							<div class="col-md-4 multi-horizontal" data-for="phone">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="publisher.id">publisher</form:label>
									<form:select path="publisher.id" class="form-control">
