...
<title>Admin-Edit-Book_SaleEvent</title>
<link rel="stylesheet"
...
<body>
	...
	<form:form method="POST"
		action="/Project1WebApplication/admin/book_SaleEvent/edit"
						...
						<div class="row row-sm-offset">
							<div class="col-md-4 multi-horizontal" data-for="name">
								<div class="form-group">
									...
									<form:input path="book.id" class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="email">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="saleevent.id">saleevent.id</form:label>
									<form:input path="saleevent.id" type="number"
											class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="phone">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="salepercent">salepercent</form:label>
									<form:input path="salepercent" type="number" class="form-control" />
								</div>
							</div>
						</div>
