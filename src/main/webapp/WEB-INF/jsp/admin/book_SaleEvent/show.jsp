...
<title>Admin-Show-Book_SaleEvent</title>
<link rel="stylesheet"
						...
						<tbody>
							<c:forEach var="listItem" items="${listBook_SaleEvent}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7">${listItem.saleevent.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.salepercent}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/book_SaleEvent/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/book_SaleEvent/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
