					...
					<table class="table isSearch" cellspacing="0">
						...
						<thead>
							<tr class="table-heads ">
								...
								<th class="head-item mbr-fonts-style display-7">note</th>
								<th class="head-item mbr-fonts-style display-7">state</th>
								<th class="head-item mbr-fonts-style display-7">user name</th>
								<th class="head-item mbr-fonts-style display-7">....</th>
								<th class="head-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/bill/add">Add</a></th>
							</tr>
						</thead>

						<tbody>
							<c:forEach var="listItem" items="${listBill}">
								<tr>
									<td class="body-item mbr-fonts-style display-7">${listItem.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.billdate}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.note}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.state}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.user.fullname}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/bill/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/bill/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
