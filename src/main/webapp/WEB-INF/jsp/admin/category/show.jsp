					...
					<table class="table isSearch" cellspacing="0">
						...
						<thead>
							<tr class="table-heads ">
								...
								<th class="head-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/category/add">Add</a></th>
							</tr>
						</thead>
						...
						<tbody>
							<c:forEach var="listItem" items="${listCategory}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/category/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/category/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
