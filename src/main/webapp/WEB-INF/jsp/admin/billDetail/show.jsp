...
<title>Admin-Show-BillDetail</title>
<link rel="stylesheet"
					...
					<table class="table isSearch" cellspacing="0">
						...
						<thead>
							<tr class="table-heads ">
								...
								<th class="head-item mbr-fonts-style display-7">bill id</th>
								...
								<th class="head-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/billDetail/add">Add</a></th>
							</tr>
						</thead>
						...
						<tbody>
							<c:forEach var="listItem" items="${listBillDetail}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7">${listItem.bill.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.book.creation.name}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.book_saleevent.salepercent}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.book_inputevent.inputprice}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/billDetail/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/billDetail/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
