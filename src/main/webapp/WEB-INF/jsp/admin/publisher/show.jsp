...
<title>Admin-Show-Publisher</title>
<link rel="stylesheet"
			...
			<div class="table-wrapper">
				...
				<div class="container scroll">
					<table class="table isSearch" cellspacing="0">
						...
						<tbody>
							<c:forEach var="listItem" items="${listPublisher}">
								<tr>
									<td class="body-item mbr-fonts-style display-7">${listItem.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.name}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/publisher/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/publisher/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
