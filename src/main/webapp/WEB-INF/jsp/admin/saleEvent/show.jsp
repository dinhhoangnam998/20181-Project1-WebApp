...
<title>Admin-Show-SaleEvent</title>
<link rel="stylesheet"
						...
						<tbody>
							<c:forEach var="listItem" items="${listSaleEvent}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7">${listItem.begindate}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.enddate}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/saleEvent/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/saleEvent/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
