...
<title>Admin-Show-Book_InputEvent</title>
<link rel="stylesheet"
					...
					<table class="table isSearch" cellspacing="0">
						...
						<thead>
							<tr class="table-heads ">
								...
								<th class="head-item mbr-fonts-style display-7">Input Event Id</th>
						...
						<tbody>
							<c:forEach var="listItem" items="${listBook_InputEvent}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7">${listItem.inputevent.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.inputprice}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.quantity}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.remain}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/book_InputEvent/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/book_InputEvent/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
