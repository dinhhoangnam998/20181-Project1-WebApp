...
<title>Admin-Add-Book_InputEvent</title>
<link rel="stylesheet"
			...
			<div class="row justify-content-center">
				<div class="media-container-column col-lg-8"
					...
					<form:form method="POST"
						action="/Project1WebApplication/admin/book_InputEvent/add"
						...
						<div class="row row-sm-offset">
							<div class="col-md-4 multi-horizontal" data-for="name">
								<div class="form-group">
									<form:label
										...
										path="book.id">book.id</form:label>
									<form:input path="book.id" type="number" class="form-control" />
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="email">
								<div class="form-group">
									<form:label
										class="form-control-label mbr-fonts-style display-7"
										path="inputevent.id">inputevent.id</form:label>
									<form:input path="inputevent.id" type="number"
										class="form-control" />
								</div>
							</div>
