...
<title>Admin-Show-InputEvent</title>
<link rel="stylesheet"
						...
						<tbody>
							<c:forEach var="listItem" items="${listInputEvent}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7">${listItem.inputdate}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/inputEvent/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/inputEvent/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
