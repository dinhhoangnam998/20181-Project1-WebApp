						...
						<tbody>
							<c:forEach var="listItem" items="${listAuthor}">
								<tr>
									...
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/author/edit?id=${listItem.id}">Edit</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/author/delete?id=${listItem.id}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
