					...
					<table class="table isSearch" cellspacing="0">
						...
						<thead>
							<tr class="table-heads ">
								...
								<th class="head-item mbr-fonts-style display-7">fullname</th>
								...
								<th class="head-item mbr-fonts-style display-7">state</th>
						...
						<tbody>
							<c:forEach var="listItem" items="${listUser}">
								<tr>
									<td class="body-item mbr-fonts-style display-7">${listItem.id}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.username}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.email}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.fullname}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.gender}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.address}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.phone}</td>
									<td class="body-item mbr-fonts-style display-7">${listItem.state}</td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/user/block?id=${listItem.id}">block</a></td>
									<td class="body-item mbr-fonts-style display-7"><a href="/Project1WebApplication/admin/user/unblock?id=${listItem.id}">unblock</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
