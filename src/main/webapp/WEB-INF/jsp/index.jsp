...
<body>
	...
	<section class="engine">
		<a href="https://mobirise.info/m">free site design templates</a>
	</section>
	<section class="mbr-section content5 cid-rcvfufkFDD" id="content5-2">
			...
			<div class="media-container-row">
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(0).id}"><img
								src="${list.get(0).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(1).id}"><img
								src="${list.get(1).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box ">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
								${list.get(1).creation.name}</h4>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(2).id}"><img
								src="${list.get(2).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
								${list.get(2).creation.name}</h4>
		...
		<div class="container">
			<div class="media-container-row">
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(3).id}"><img
								src="${list.get(3).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(4).id}"><img
								src="${list.get(4).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box ">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
								${list.get(4).creation.name}</h4>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(5).id}"><img
								src="${list.get(5).imageurl}" alt="BookImage" title="moreinfo"
								height="469" width="670"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
								${list.get(5).creation.name}</h4>
			...
			<div class="row media-row">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(6).id}"><img
							src="${list.get(6).imageurl}" alt="BookImage" title="moreinfo"
							height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">
								${list.get(6).creation.name}</p>
						</div>
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(7).id}"><img
							src="${list.get(7).imageurl}" alt="BookImage" title="moreinfo"
							height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">
								${list.get(7).creation.name}</p>
						</div>
						<div class="item-role px-2">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(8).id}"><img
							src="${list.get(8).imageurl}" alt="BookImage" title="moreinfo"
							height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">
								${list.get(8).creation.name}</p>
						</div>
						<div class="item-role px-2">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(9).id}"><img
							src="${list.get(9).imageurl}" alt="BookImage" title="moreinfo"
							height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">
								${list.get(9).creation.name}</p>
						</div>
						<div class="item-role px-2">
	...
	<section class="features16 cid-rcy602kxR5" id="features16-6">
		...
		<div class="container align-center">
			...
			<div class="row media-row">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(10).id}"><img
							src="/Project1WebApplication/resources/assets/images/6-1-308x431.jpg"
							alt="BookImage" title="moreinfo" height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">book.creation.name</p>
						</div>
						<div class="item-role px-2">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(11).id}"><img
							src="/Project1WebApplication/resources/assets/images/7-1-313x445.jpg"
							alt="BookImage" title="moreinfo" height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(12).id}"><img
							src="/Project1WebApplication/resources/assets/images/8-208x350.jpg"
							alt="BookImage" title="moreinfo" height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
				...
				<div class="team-item col-lg-3 col-md-6">
					<div class="item-image">
						<a href="/Project1WebApplication/book/info?id=${list.get(13).id}"><img
							src="/Project1WebApplication/resources/assets/images/12-1-400x543.jpg"
							alt="BookImage" title="moreinfo" height="357" width="509"></a>
					</div>
					<div class="item-caption py-3">
						<div class="item-name px-2">
		...
		<div class="container-fluid">
			<div class="media-container-row">
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(14).id}"><img
								src="/Project1WebApplication/resources/assets/images/2-432x536.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(15).id}"><img
								src="/Project1WebApplication/resources/assets/images/5-432x614.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(16).id}"><img
								src="/Project1WebApplication/resources/assets/images/2-432x648.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(17).id}"><img
								src="/Project1WebApplication/resources/assets/images/1-432x679.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(1).id}"><img
								src="/Project1WebApplication/resources/assets/images/1-432x694.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(2).id}"><img
								src="/Project1WebApplication/resources/assets/images/2-432x631.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
			...
			<div class="media-container-row">
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(3).id}"><img
								src="/Project1WebApplication/resources/assets/images/3-432x620.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(4).id}"><img
								src="/Project1WebApplication/resources/assets/images/2-349x499.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<img
								src="/Project1WebApplication/resources/assets/images/3-333x500.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420">
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
								book.creation.name</h4>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(5).id}"><img
								src="/Project1WebApplication/resources/assets/images/15-432x826.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(6).id}"><img
								src="/Project1WebApplication/resources/assets/images/2-432x618.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-2">
					<div class="card-wrapper">
						<div class="card-img">
							<a href="/Project1WebApplication/book/info?id=${list.get(7).id}"><img
								src="/Project1WebApplication/resources/assets/images/11-432x576.jpg"
								alt="BookImage" title="moreinfo" height="273" width="420"></a>
						</div>
						<div class="card-box">
							<h4 class="card-title pb-3 mbr-fonts-style display-7">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
						<p class="mbr-text mbr-fonts-style display-7">
							...
							your page, add content and style it to look the way you like. <a
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
						<p class="mbr-text mbr-fonts-style display-7">
							All sites you make with Mobirise are mobile-friendly. You don't
							have to create a special mobile version of your site. <a
								href="https://mobirise.co">Learn more...</a>
						</p>
					</div>
				</div>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
						<p class="mbr-text mbr-fonts-style display-7">
							Mobirise offers many site blocks in several themes, and though
							these blocks are pre-made, they are flexible. <a
								href="https://mobirise.co">Learn more...</a>
						</p>
					</div>
				</div>
				...
				<div class="col-12 col-md-3 mbr-fonts-style display-7">
					...
					<p class="mbr-text">
						<a href="https://www.manganetworks.co/anime/" target="_blank">Manga
							news</a><br>
						<a href="https://tinanime.com/the-loai/de-cu-anime"
							target="_blank">Recomment Manga</a><br>
						<a href="https://vuighe.net/" target="_blank">Anime movie</a>
					</p>
				</div>
			</div>
