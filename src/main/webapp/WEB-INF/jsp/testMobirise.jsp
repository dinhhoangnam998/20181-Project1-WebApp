...
<body>
  <section class="menu cid-rbJ3pCw60a" once="menu" id="menu1-0">
  ...
  <section class="engine"><a href="https://mobirise.info/j">website templates</a></section><script src="<%=request.getContextPath()%>/resources/assets/web/assets/jquery/jquery.min.js"></script>
