					...
					<div class=" align-left aside-content">
						...
						<div class="block-content">
							<div class="card p-3 pr-3">
								...
								<div class="card-box">
									<p class="block-text mbr-fonts-style display-4">CoverPrice:<s> ${book.coverprice} &#8363;</s></p>
								</div>

								<div class="card-box">
									<p class="block-text mbr-fonts-style display-4">Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ${book.coverprice * 90 / 100} &#8363;</p>
								</div>
							</div>
							...
							<div class="card p-3 pr-3">
								...
								<div class="card-box">
									<p class="block-text mbr-fonts-style display-4">Status: In Stock </s></p>
								</div>
