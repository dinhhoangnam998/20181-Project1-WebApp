...
<body>
	<section class="menu cid-rcpkOJpLEL" once="menu" id="menu1-1y">
	...
	<section class="cid-rb5Daq7KkO mbr-fullscreen mbr-parallax-background"
		id="header15-v">
	...
	<section class="toggle1 cid-rb5D1OCuxz" id="toggle1-t">
					...
					<div id="bootstrap-toggle"
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black"
									...
									href="#collapse1_14" aria-expanded="false"
							...
							<div id="collapse1_14" class="panel-collapse noScroll collapse"
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingTwo">
								<a role="button" class="collapsed panel-title text-black"
									data-toggle="collapse" data-parent="#accordion" data-core=""
									href="#collapse2_14" aria-expanded="false"
							...
							<div id="collapse2_14" class="panel-collapse noScroll collapse"
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingThree">
								<a role="button" class="collapsed panel-title text-black"
									data-toggle="collapse" data-parent="#accordion" data-core=""
									href="#collapse3_14" aria-expanded="false"
							...
							<div id="collapse3_14" class="panel-collapse noScroll collapse"
	...
	<section class="cid-rcp7fzkbM8" id="footer1-1o">
		...
		<div class="container">
			<div class="media-container-row content text-white">
				...
				<div class="col-12 col-md-3 mbr-fonts-style display-7">
					...
					<p class="mbr-text">
						Manga news<br>Top manga of week<br>Anime movie
					</p>
				</div>
			</div>
	...
	<script
		src="<%=request.getContextPath()%>/resources/assets/parallax/jarallax.min.js"></script>
	<script
		src="<%=request.getContextPath()%>/resources/assets/mbr-switch-arrow/mbr-switch-arrow.js"></script>
	<script
