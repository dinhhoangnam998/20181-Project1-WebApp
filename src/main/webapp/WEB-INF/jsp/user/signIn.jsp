...
<body>
	...
	<section class="mbr-section content5 cid-rcvvuBFZn7" id="content5-18">
				...
				<div class="col-lg-4 col-md-5">
					<div class="form-container">
						<div class="media-container-column" data-form-type="formoid">
							...
							<form class="mbr-form"
								action="/Project1WebApplication/user/signIn" method="POST">
								<div>
								...
								<span class="input-group-btn"><input type="submit"
									value="Sign In" class="btn btn-primary btn-form display-4" /><br>
								</span>
							</form>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="panel-title collapsed text-black"
									data-toggle="collapse" data-core="" href="#collapse1_18"
							...
							<div id="collapse1_18" class="panel-collapse noScroll collapse "
								role="tabpanel" aria-labelledby="headingOne"
								data-parent="#bootstrap-accordion_18">
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingTwo">
								<a role="button" class="collapsed panel-title text-black"
									data-toggle="collapse" data-core="" href="#collapse2_18"
							...
							<div id="collapse2_18" class="panel-collapse noScroll collapse"
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingThree">
								<a role="button" class="collapsed text-black panel-title"
									data-toggle="collapse" data-core="" href="#collapse3_18"
							...
							<div id="collapse3_18" class="panel-collapse noScroll collapse"
	...
	<script
		src="/Project1WebApplication/resources/assets/parallax/jarallax.min.js"></script>
	<script
		src="/Project1WebApplication/resources/assets/mbr-switch-arrow/mbr-switch-arrow.js"></script>
	<script
