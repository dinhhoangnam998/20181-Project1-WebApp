...
<body>
  <section class="menu cid-rcAl3sSLlJ" once="menu" id="menu1-4">
...
<section class="engine"><a href="https://mobirise.info/t">free amp template</a></section><section class="mbr-section content5 cid-rcvvuBFZn7" id="content5-18">
...
<section class="cid-rcvjBz529M mbr-parallax-background" id="header15-i">
...
<div class="row">
    ...
    <div class="form-container">
        <div class="media-container-column" data-form-type="formoid">
            ...
            <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="4M4+ZK0zfPv+JXnWmKHSqgXQg06zj57o5CZEBLGS+h2bBuQojXsklzmlyu6DgNVv3pAe5ksIj3W0slgyMKrKJ/QcIOcOjAzRyIUwXjbILk9ghioiHY8i3elCqCID+YSx">
                <div data-for="name">
...
<section class="accordion1 cid-rcvlRdvZ07" id="accordion1-t">
                ...
                <div id="bootstrap-accordion_18" class="panel-group accordionStyles accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingThree">
                            <a role="button" class="collapsed text-black panel-title" data-toggle="collapse" data-core="" href="#collapse3_18" aria-expanded="false" aria-controls="collapse3">
                                <h4 class="mbr-fonts-style display-5">
                                    <span class="sign mbr-iconfont mbri-arrow-down inactive"></span> Why MangaWorld?
                                </h4>
                            </a>
                        </div>
...
<section class="cid-rcvAdwRNBg" id="footer1-1e">
  ...
  <script src="/Project1WebApplication/resources/assets/parallax/jarallax.min.js"></script>
  <script src="/Project1WebApplication/resources/assets/mbr-switch-arrow/mbr-switch-arrow.js"></script>
