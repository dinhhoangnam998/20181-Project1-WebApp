...
<section class="engine"><a href="https://mobirise.info/p">web templates free download</a></section><section class="mbr-section form1 cid-rb5oVrnQg6" id="form1-j">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="/registry" method="post">
                        ...
                        <span class="input-group-btn"><button href="" type="submit" class="btn btn-primary btn-form display-4">Sign up<br></button></span>
                    </form>
            </div>
        </div>
    </div>
...
<section class="footer4 cid-rbKh9C5Jrd" id="footer4-1b">
            ...
            <div class="col-md-4 offset-md-1 col-sm-12">
                ...
                <div class="media-container-column" data-form-type="formoid">
                    ...
                    <form class="form-inline" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form">
                        <input type="hidden" value="y5LETVyT9aNgBHx6+L1JUAsQ9XXFchHswZASUjeP3wZPBfXkLJvM4Yp1wfTJDdkgdOJKC/OrHhiIfTTpTKtPakGuUfg+to42TpqXgjOMsTb6deVTy34I9ajnwgkzfzDE" data-form-email="true">
                        <div class="form-group">
  ...
  <script src="<%=request.getContextPath()%>/resources/assets/viewportchecker/jquery.viewportchecker.js"></script>
