...
<body>
  <section class="menu cid-rbKhhHv1zh" once="menu" id="menu1-1d">
...
<section class="footer4 cid-rbKhfGDYgw" id="footer4-1c">
  ...
  <script src="<%=request.getContextPath()%>/resources/assets/mbr-switch-arrow/mbr-switch-arrow.js"></script>
